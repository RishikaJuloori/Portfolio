export const profile = {
  ...
  subTagline:
    "I turn messy, high-stakes problems into something legible enough to act on: a million-record migration, a satellite's collision risk, a raga's rhythm cycle.",
};
...
export const projects: Project[] = [
  {
    ...
    links: [
      {
        label: "Live demo",
        href: "https://v0-satellite-collision-avoidance.vercel.app",
        kind: "demo",
      },
    ],
    problem:
...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    oneLiner:
      "Half the traffic was leaving money on the table, so I grew it with SEO and untangled a 430K-row database for the sales team.",
    stats: [
